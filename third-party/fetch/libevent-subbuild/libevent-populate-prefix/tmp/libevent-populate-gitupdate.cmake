...
execute_process(
  COMMAND "/usr/bin/git" show-ref "release-2.1.12-stable"
  WORKING_DIRECTORY "/app/source/cvs/third-party/fetch/libevent-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "release-2.1.12-stable")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("release-2.1.12-stable" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/release-2.1.12-stable")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/app/source/cvs/third-party/fetch/libevent-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/app/source/cvs/third-party/fetch/libevent-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
